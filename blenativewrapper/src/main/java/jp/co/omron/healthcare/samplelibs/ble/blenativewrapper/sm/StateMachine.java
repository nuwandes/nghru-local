...
public abstract class StateMachine {
    ...
    protected final Message obtainMessage(int what, int arg1) {
        // use this obtain so we don't match the obtain(h, what, Object) method
        return Message.obtain(mSmHandler, what, arg1, 0);
    }

    protected final Message obtainMessage(int what, int arg1, int arg2) {
        return Message.obtain(mSmHandler, what, arg1, arg2);
    }

    protected final Message obtainMessage(int what, int arg1, int arg2, Object obj) {
    ...
    protected final void sendMessage(int what, int arg1) {
    ...
    protected final void sendMessageDelayed(int what, Object obj, long delayMillis) {
        mSmHandler.sendMessageDelayed(obtainMessage(what, obj), delayMillis);
    }

    protected final void sendMessageDelayed(int what, int arg1, long delayMillis) {
    ...
    protected final void sendMessageDelayed(int what, int arg1, int arg2, Object obj, long delayMillis) {
